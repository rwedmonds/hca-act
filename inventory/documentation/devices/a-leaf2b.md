...
| --------- | --------------- | ------------ | --------- |
| a-leaf2 | Vlan4094 | 10.255.255.28 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | L2_a-leaf2c_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 5 |
| Ethernet6 | L2_a-leaf2d_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 6 |
| Ethernet11 | MLAG_a-leaf2a_Ethernet11 | *trunk | *2-4094 | *- | *MLAG | 11 |
| Ethernet12 | MLAG_a-leaf2a_Ethernet12 | *trunk | *2-4094 | *- | *MLAG | 11 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_a-spine1_Ethernet8 | - | 172.16.0.61/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_a-spine2_Ethernet8 | - | 172.16.0.63/31 | default | 1500 | False | - | - |
...
!
interface Ethernet5
   description L2_a-leaf2c_Ethernet2
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description L2_a-leaf2d_Ethernet2
   no shutdown
   channel-group 6 mode active
!
interface Ethernet11
   description MLAG_a-leaf2a_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_a-leaf2a_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_a-leaf2a_Port-Channel11 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_a-leaf2a_Port-Channel11
   no shutdown
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description a-leaf2a
   ...
   neighbor 10.255.254.28 description a-leaf2a_Vlan4093
   ...
   neighbor 172.16.0.60 description a-spine1_Ethernet8
   neighbor 172.16.0.62 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.0.62 remote-as 65100
   neighbor 172.16.0.62 description a-spine2_Ethernet8
