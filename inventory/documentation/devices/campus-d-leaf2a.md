...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.65 | 192.168.0.1 |
...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS campus-d-leaf2a | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS campus-d-leaf2a
```
...
| --------- | --------------- | ------------ | --------- |
| campus-d-leaf2 | Vlan4094 | 192.168.255.5 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_campus-d-spine1_Ethernet7 | *trunk | *10,20,30,40 | *- | *- | 1 |
| Ethernet2 | L2_campus-d-spine2_Ethernet7 | *trunk | *10,20,30,40 | *- | *- | 1 |
| Ethernet5 | L2_campus-d-leaf2c_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 5 |
| Ethernet6 | L2_campus-d-leaf2d_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 6 |
| Ethernet11 | MLAG_campus-d-leaf2b_Ethernet11 | *trunk | *2-4094 | *- | *MLAG | 11 |
| Ethernet12 | MLAG_campus-d-leaf2b_Ethernet12 | *trunk | *2-4094 | *- | *MLAG | 11 |
...
!
interface Ethernet1
   description L2_campus-d-spine1_Ethernet7
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_campus-d-spine2_Ethernet7
   no shutdown
   channel-group 1 mode active
!
interface Ethernet5
   description L2_campus-d-leaf2c_Ethernet1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description L2_campus-d-leaf2d_Ethernet1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet11
   description MLAG_campus-d-leaf2b_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_campus-d-leaf2b_Ethernet12
   no shutdown
   channel-group 11 mode active
!
interface Management1
...
| Port-Channel11 | MLAG_campus-d-leaf2b_Port-Channel11 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_campus-d-leaf2b_Port-Channel11
   no shutdown
