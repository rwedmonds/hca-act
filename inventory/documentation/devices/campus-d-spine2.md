...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.62 | 192.168.0.1 |
...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS campus-d-spine2 | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS campus-d-spine2
```
...
| --------- | --------------- | ------------ | --------- |
| campus-d-spines | Vlan4094 | 192.168.255.0 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | L2_campus-d-leaf1a_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 5 |
| Ethernet6 | L2_campus-d-leaf1b_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 5 |
| Ethernet7 | L2_campus-d-leaf2a_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 7 |
| Ethernet8 | L2_campus-d-leaf2b_Ethernet2 | *trunk | *10,20,30,40 | *- | *- | 7 |
| Ethernet11 | MLAG_campus-d-spine1_Ethernet11 | *trunk | *2-4094 | *- | *MLAG | 11 |
| Ethernet12 | MLAG_campus-d-spine1_Ethernet12 | *trunk | *2-4094 | *- | *MLAG | 11 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | - | - | 169.254.40.2/31 | default | - | False | - | - |
...
interface Ethernet1
   no shutdown
   no switchport
   ip address 169.254.40.2/31
!
interface Ethernet5
   description L2_campus-d-leaf1a_Ethernet2
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description L2_campus-d-leaf1b_Ethernet2
   no shutdown
   channel-group 5 mode active
!
interface Ethernet7
   description L2_campus-d-leaf2a_Ethernet2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description L2_campus-d-leaf2b_Ethernet2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet11
   description MLAG_campus-d-spine1_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_campus-d-spine1_Ethernet12
   no shutdown
   channel-group 11 mode active
!
interface Management1
...
| Port-Channel11 | MLAG_campus-d-spine1_Port-Channel11 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_campus-d-spine1_Port-Channel11
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 172.16.40.2/32 |
...
| Vlan3009 |  default  |  192.168.254.1/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 169.254.40.3 | Inherited from peer group WAN | default | - | Inherited from peer group WAN | Inherited from peer group WAN | - | Inherited from peer group WAN | - | - | - | - |
...
router bgp 65401
   ...
   neighbor 169.254.40.3 peer group WAN
   neighbor 169.254.40.3 description WAN Router
```
