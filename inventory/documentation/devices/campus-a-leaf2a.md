...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | L2_campus-a-leaf2c_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 5 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_campus-a-spine1_Ethernet7 | - | 172.16.0.57/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_campus-a-spine2_Ethernet7 | - | 172.16.0.59/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_campus-a-spine1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_campus-a-spine2_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description L2_campus-a-leaf2c_Ethernet1
   no shutdown
...
router bgp 65102
   ...
   neighbor 172.16.0.56 description campus-a-spine1_Ethernet7
   neighbor 172.16.0.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.0.58 remote-as 65100
   neighbor 172.16.0.58 description campus-a-spine2_Ethernet7
