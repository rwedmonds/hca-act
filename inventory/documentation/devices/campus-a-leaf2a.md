...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.35/24 | 192.168.0.1 |
...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS_A campus-a-leaf2a | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS_A campus-a-leaf2a
```
...
| --------- | --------------- | ------------ | --------- |
| campus-a-leaf2 | Vlan4094 | 10.255.255.29 | Port-Channel11 |
...
mlag configuration
   ...
   peer-address heartbeat 192.168.0.36
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet11 | MLAG_campus-a-leaf2b_Ethernet11 | *trunk | *2-4094 | *- | *MLAG | 11 |
| Ethernet12 | MLAG_campus-a-leaf2b_Ethernet12 | *trunk | *2-4094 | *- | *MLAG | 11 |
...
interface Ethernet11
   description MLAG_campus-a-leaf2b_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_campus-a-leaf2b_Ethernet12
   no shutdown
   channel-group 11 mode active
!
interface Management1
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel11 | MLAG_campus-a-leaf2b_Port-Channel11 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_campus-a-leaf2b_Port-Channel11
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.244.15/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.243.15/32 |
| Loopback100 | DIAG_VRF_Blue | Blue | 192.168.200.15/32 |
...
| Vlan3009 |  Blue  |  10.255.254.28/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Red  |  10.255.254.28/31  |  -  |  -  |  -  |  -  |
| Vlan3011 |  Green  |  10.255.254.28/31  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description campus-a-leaf2a_VTEP
...
| 10.255.254.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.254.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Green | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.254.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue | 192.168.244.15:10 | 10:10 | - | - | learned | 110-113 |
| Green | 192.168.244.15:12 | 12:12 | - | - | learned | 130-131 |
| Red | 192.168.244.15:11 | 11:11 | - | - | learned | 120-121 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Blue | 192.168.244.15:10 | connected | - |
| Green | 192.168.244.15:12 | connected | - |
| Red | 192.168.244.15:11 | connected | - |
...
router bgp 65103
   ...
   vrf Blue
      ...
      router-id 192.168.244.15
      neighbor 10.255.254.29 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.29 description campus-a-leaf2b_Vlan3009
   ...
   vrf Green
      ...
      router-id 192.168.244.15
      neighbor 10.255.254.29 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.29 description campus-a-leaf2b_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf Red
      rd 192.168.244.15:11
      ...
      router-id 192.168.244.15
      neighbor 10.255.254.29 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.29 description campus-a-leaf2b_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ip address virtual source-nat vrf Blue address 192.168.200.15
```
