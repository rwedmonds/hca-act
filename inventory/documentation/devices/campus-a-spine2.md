...
| Ethernet7 | P2P_campus-a-leaf2a_Ethernet2 | - | 172.16.0.58/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_campus-a-leaf2b_Ethernet2 | - | 172.16.0.62/31 | default | 1500 | False | - | - |
...
!
interface Ethernet7
   description P2P_campus-a-leaf2a_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_campus-a-leaf2b_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 172.16.0.59 description campus-a-leaf2a_Ethernet2
   neighbor 172.16.0.63 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.0.63 remote-as 65102
   neighbor 172.16.0.63 description campus-a-leaf2b_Ethernet2
