...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.61 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| d-spines | Vlan4094 | 192.168.255.1 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | L2_d-leaf1a_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 5 |
| Ethernet6 | L2_d-leaf1b_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 5 |
| Ethernet7 | L2_d-leaf2a_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 7 |
| Ethernet8 | L2_d-leaf2b_Ethernet1 | *trunk | *10,20,30,40 | *- | *- | 7 |
| Ethernet11 | MLAG_d-spine2_Ethernet11 | *trunk | *2-4094 | *- | *MLAG | 11 |
| Ethernet12 | MLAG_d-spine2_Ethernet12 | *trunk | *2-4094 | *- | *MLAG | 11 |
...
!
interface Ethernet5
   description L2_d-leaf1a_Ethernet1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description L2_d-leaf1b_Ethernet1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet7
   description L2_d-leaf2a_Ethernet1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description L2_d-leaf2b_Ethernet1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet11
   description MLAG_d-spine2_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_d-spine2_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_d-spine2_Port-Channel11 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_d-spine2_Port-Channel11
   no shutdown
