...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.43/24 | 192.168.0.1 |
...
mlag configuration
   ...
   peer-address heartbeat 192.168.0.44 vrf MGMT
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | SERVER_campus-b-leaf1-server1_Ethernet1 | *access | *110,110-113,120-121,130-131 | *- | *- | 5 |
| Ethernet6 | L2_campus-b-leaf2d_Ethernet1 | *trunk | *110-113,120-121,130-131 | *- | *- | 6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_campus-b-spine1_Ethernet5 | - | 172.31.254.89/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_campus-b-spine2_Ethernet5 | - | 172.31.254.91/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | SERVER_campus-b-leaf1-server1 | access | 110,110-113,120-121,130-131 | - | - | - | - | 5 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.234.23/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.233.23/32 |
| Loopback100 | DIAG_VRF_Blue | Blue | 192.168.200.23/32 |
...
| Vlan3009 |  Blue  |  10.255.254.44/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Red  |  10.255.254.44/31  |  -  |  -  |  -  |  -  |
| Vlan3011 |  Green  |  10.255.254.44/31  |  -  |  -  |  -  |  -  |
...
| 172.31.254.88 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.254.90 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.254.45 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.254.45 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Green | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.254.45 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue | 192.168.234.23:10 | 10:10 | - | - | learned | 110-113 |
| Green | 192.168.234.23:12 | 12:12 | - | - | learned | 130-131 |
| Red | 192.168.234.23:11 | 11:11 | - | - | learned | 120-121 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Blue | 192.168.234.23:10 | connected | - |
| Green | 192.168.234.23:12 | connected | - |
| Red | 192.168.234.23:11 | connected | - |
...
router bgp 65102
   ...
   neighbor 172.31.254.88 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.254.88 remote-as 65101
   neighbor 172.31.254.88 description campus-b-spine1_Ethernet5
   neighbor 172.31.254.90 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.254.90 remote-as 65101
   neighbor 172.31.254.90 description campus-b-spine2_Ethernet5
   ...
   vlan-aware-bundle Blue
      rd 192.168.234.23:10
      route-target both 10:10
      redistribute learned
      vlan 110-113
   !
   vlan-aware-bundle Green
      rd 192.168.234.23:12
      route-target both 12:12
      redistribute learned
      vlan 130-131
   !
   vlan-aware-bundle Red
      rd 192.168.234.23:11
   ...
   vrf Blue
      ...
      router-id 192.168.234.23
      neighbor 10.255.254.45 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.45 description campus-b-leaf1b_Vlan3009
   ...
   vrf Green
      ...
      router-id 192.168.234.23
      neighbor 10.255.254.45 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.45 description campus-b-leaf1b_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf Red
      rd 192.168.234.23:11
      ...
      router-id 192.168.234.23
      neighbor 10.255.254.45 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.45 description campus-b-leaf1b_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ip address virtual source-nat vrf Blue address 192.168.200.23
```
