...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.64 | 192.168.0.1 |
...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS campus-d-leaf1b | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS campus-d-leaf1b
```
...
| --------- | --------------- | ------------ | --------- |
| campus-d-leaf1 | Vlan4094 | 192.168.255.0 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_campus-d-spine1_Ethernet6 | *trunk | *10,20,30,40 | *- | *- | 1 |
| Ethernet2 | L2_campus-d-spine2_Ethernet6 | *trunk | *10,20,30,40 | *- | *- | 1 |
| Ethernet11 | MLAG_campus-d-leaf1a_Ethernet11 | *trunk | *2-4094 | *- | *MLAG | 11 |
| Ethernet12 | MLAG_campus-d-leaf1a_Ethernet12 | *trunk | *2-4094 | *- | *MLAG | 11 |
...
!
interface Ethernet1
   description L2_campus-d-spine1_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_campus-d-spine2_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Ethernet11
   description MLAG_campus-d-leaf1a_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_campus-d-leaf1a_Ethernet12
   no shutdown
   channel-group 11 mode active
!
interface Management1
...
| Port-Channel11 | MLAG_campus-d-leaf1a_Port-Channel11 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description L2_campus-d-spines_Port-Channel5
   no shutdown
...
interface Port-Channel11
   description MLAG_campus-d-leaf1a_Port-Channel11
   no shutdown
