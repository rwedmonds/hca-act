...
| --------- | --------------- | ------------ | --------- |
| campus-c-leaf2 | Vlan4094 | 10.255.255.68 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_campus-c-leaf2a_Ethernet3 | *trunk | *2-4094 | *- | *MLAG | 3 |
| Ethernet4 | MLAG_campus-c-leaf2a_Ethernet4 | *trunk | *2-4094 | *- | *MLAG | 3 |
...
!
interface Ethernet3
   description MLAG_campus-c-leaf2a_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_campus-c-leaf2a_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Management1
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_campus-c-leaf2a_Port-Channel3 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_campus-c-leaf2a_Port-Channel3
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.224.36/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.223.35/32 |
| Loopback100 | DIAG_VRF_Blue | Blue | 192.168.200.36/32 |
...
| Vlan3009 |  Blue  |  10.255.254.69/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Red  |  10.255.254.69/31  |  -  |  -  |  -  |  -  |
| Vlan3011 |  Green  |  10.255.254.69/31  |  -  |  -  |  -  |  -  |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue | 192.168.224.36:10 | 10:10 | - | - | learned | 110-113 |
| Green | 192.168.224.36:12 | 12:12 | - | - | learned | 130-131 |
| Red | 192.168.224.36:11 | 11:11 | - | - | learned | 120-121 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Blue | 192.168.224.36:10 | connected | - |
| Green | 192.168.224.36:12 | connected | - |
| Red | 192.168.224.36:11 | connected | - |
...
router bgp 65303
   ...
   vlan-aware-bundle Blue
      rd 192.168.224.36:10
      route-target both 10:10
      redistribute learned
      vlan 110-113
   !
   vlan-aware-bundle Green
      rd 192.168.224.36:12
      route-target both 12:12
      redistribute learned
      vlan 130-131
   !
   vlan-aware-bundle Red
      rd 192.168.224.36:11
   ...
   vrf Blue
      ...
      router-id 192.168.224.36
      neighbor 10.255.254.68 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.68 description campus-c-leaf2a_Vlan3009
   ...
   vrf Green
      ...
      router-id 192.168.224.36
      neighbor 10.255.254.68 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.68 description campus-c-leaf2a_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf Red
      rd 192.168.224.36:11
      ...
      router-id 192.168.224.36
      neighbor 10.255.254.68 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.254.68 description campus-c-leaf2a_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ip address virtual source-nat vrf Blue address 192.168.200.36
```
