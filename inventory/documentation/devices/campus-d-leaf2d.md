...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.68 | 192.168.0.1 |
...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS campus-d-leaf2d | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS campus-d-leaf2d
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_campus-d-leaf2a_Ethernet6 | *trunk | *10,20,30,40 | *- | *- | 1 |
| Ethernet2 | L2_campus-d-leaf2b_Ethernet6 | *trunk | *10,20,30,40 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_campus-d-leaf2a_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_campus-d-leaf2b_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Management1
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_campus-d-leaf2_Port-Channel6 | trunk | 10,20,30,40 | - | - | - | - | - | - |
...
interface Port-Channel1
   description L2_campus-d-leaf2_Port-Channel6
   no shutdown
