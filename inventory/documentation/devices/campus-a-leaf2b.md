...
| --------- | --------------- | ------------ | --------- |
| campus-a-leaf2 | Vlan4094 | 10.255.255.28 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_campus-a-leaf2a_Ethernet3 | *trunk | *2-4094 | *- | *MLAG | 3 |
| Ethernet4 | MLAG_campus-a-leaf2a_Ethernet4 | *trunk | *2-4094 | *- | *MLAG | 3 |
...
!
interface Ethernet3
   description MLAG_campus-a-leaf2a_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_campus-a-leaf2a_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Management1
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_campus-a-leaf2a_Port-Channel3 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_campus-a-leaf2a_Port-Channel3
   no shutdown
