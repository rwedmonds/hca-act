...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS_A campus-a-leaf2d | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS_A campus-a-leaf2d
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_campus-a-leaf1a_Ethernet6 | *trunk | *110-113,120-121,130-131 | *- | *- | 1 |
| Ethernet2 | L2_campus-a-leaf1b_Ethernet6 | *trunk | *110-113,120-121,130-131 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_campus-a-leaf1a_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_campus-a-leaf1b_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Management1
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_campus-a-leaf1_Port-Channel6 | trunk | 110-113,120-121,130-131 | - | - | - | - | - | - |
...
interface Port-Channel1
   description L2_campus-a-leaf1_Port-Channel6
   no shutdown
