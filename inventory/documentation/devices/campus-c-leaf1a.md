...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.53/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| campus-c-leaf1 | Vlan4094 | 10.255.255.65 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 192.168.0.54 vrf MGMT
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_campus-c-leaf1b_Ethernet3 | *trunk | *2-4094 | *- | *MLAG | 3 |
| Ethernet4 | MLAG_campus-c-leaf1b_Ethernet4 | *trunk | *2-4094 | *- | *MLAG | 3 |
...
!
interface Ethernet3
   description MLAG_campus-c-leaf1b_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_campus-c-leaf1b_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_campus-c-leaf1b_Port-Channel3 | trunk | 2-4094 | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_campus-c-leaf1b_Port-Channel3
   no shutdown
