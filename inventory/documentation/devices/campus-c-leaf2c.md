...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.57/24 | 192.168.0.1 |
...
| ------- | -------- | ---------- | ----- |
| - | HCA CAMPUS campus-c-leaf2c | All | Disabled |

#### SNMP Device Configuration

```eos
!
snmp-server location HCA CAMPUS campus-c-leaf2c
```
